...
## Code Question B and clustered Plots:
```{r include=TRUE}
...
## Code Question C and error Plots:
```{r include=TRUE}
...
### Question on Elbow point: 
Looking at the above graph, the elbow point is 6 for the k value. This can be seen because the slope becomes less steep.
