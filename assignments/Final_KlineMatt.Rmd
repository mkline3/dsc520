...
## Code for initial analysis and initial predictive model:
```{r include=TRUE}
...
## Code for 3 new models including each of the different term periods:
```{r include=TRUE}
#Including G1
...
## Code all graphs used in analysis:
```{r include=TRUE}
